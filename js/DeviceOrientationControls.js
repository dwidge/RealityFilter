  ...
  THREE.DeviceOrientationControls = function (object) {
    ...
    this.update = (function (delta) {
      return function (delta) {
        ...
        // orient the device
        if (this.autoAlign)
          this.orientationQuaternion.copy(
            quaternion
          ); // interpolation breaks the auto alignment
        ...
        this.orientationQuaternion.multiply(
          q0.setFromAxisAngle(zee, -this.orient)
        );
    ...
    this.align = function () {
      tempVector3
        .set(0, 0, -1)
        .applyQuaternion(
          tempQuaternion.copy(this.orientationQuaternion).inverse(),
          "ZXY"
        );
